...
json active_world_mechanisms() {
  return json::array({
      ...
      {{"key","campfire_night_routine"},
       {"summary","Les journées comportent 1800 cycles de jour puis 600 cycles de nuit. Les personnages allument un feu, y reviennent la nuit et utilisent sa réserve commune pour déposer, transporter et partager une nourriture collectée."},
       {"resources",{"branches","feu de camp","mémoire des feux","phase jour-nuit","réserve commune","nourriture transportée"}},
