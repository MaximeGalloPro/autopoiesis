...
json active_world_mechanisms() {
  return json::array({
      ...
      {{"key","campfire_night_routine"},
       {"summary","Les journées comportent 1800 cycles de jour puis 600 cycles de nuit. Des branches apparaissent au pied des arbres ; les personnages peuvent les ramasser, allumer un feu et rejoindre la nuit un feu déjà observé."},
       {"resources",{"branches","feu de camp","mémoire des feux","phase jour-nuit"}},
       {"actions",{"collect_branch","build_campfire","rest_by_campfire"}}},
