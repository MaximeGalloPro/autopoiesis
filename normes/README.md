...
Règle d'interface : la fenêtre raylib reçoit uniquement un instantané en lecture seule du moteur. Pour la validation, elle affiche les trois demandes sous forme de cartes et renvoie seulement une commande à `HumanValidation`, qui reste l'unique autorité sur les statuts. Le mode terminal reste disponible.
