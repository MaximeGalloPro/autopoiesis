...
- La validation humaine doit rester intégrée au processus interactif ; ne pas demander à l'utilisateur de lancer un second script ou terminal pour débloquer la simulation.
